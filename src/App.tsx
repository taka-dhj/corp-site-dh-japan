      ...
      >
        <div className="w-full px-8 md:px-12">
          ...
          <div className="hidden md:grid lg:hidden md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="group relative h-[500px] rounded-2xl overflow-hidden md:col-start-1 md:col-span-1">
              <img 
                src="https://images.pexels.com/photos/1320684/pexels-photo-1320684.jpeg?auto=compress&cs=tinysrgb&w=600&h=800&fit=crop" 
                alt="Sales Phase"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
            ...
            <div className="group relative h-[500px] rounded-2xl overflow-hidden md:col-start-3 md:col-span-1">
              <img 
                src="https://images.pexels.com/photos/46253/mt-fuji-sea-of-clouds-sunrise-46253.jpeg?auto=compress&cs=tinysrgb&w=600&h=800&fit=crop" 
                alt="Reinvestment Phase"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              ...
              >
                <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                  <div className="lg:w-1/2">
                    {/* Show DHJ Privé CTA instead of image for Custom Travel service (index 3) */}
                    {index === 3 ? (
                      <div className="relative h-96 overflow-hidden rounded-lg shadow-2xl">
                        <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden flex items-center justify-center p-8">
                          ...
                          <div className="relative z-10 text-center">
                            ...
                            <h4 className="text-4xl font-light text-white mb-4">
                              DHJ Privé
                            </h4>
                            <p className="text-gray-200 mb-8 leading-relaxed text-lg max-w-md mx-auto">
                              {i18n.language === 'ja' 
